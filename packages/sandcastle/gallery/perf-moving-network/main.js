...
// Shared simulation — positions tick every frame, colours + rewires
// tick every second. Everything downstream is just rendering.
const {
  model,
  addAssetVisual,
  installFrameTimeLogger,
...
// --- Rendering: BufferPolylineCollection + BillboardCollection ---------
...
// One buffer polyline per connection, sharing a single material.
...
// --- Tick loop -----------------------------------------------------------
// Time comes from viewer.clock so timeline scrub/speed affects motion.
viewer.scene.preRender.addEventListener(() => {
  ...
  // Move billboards + labels for every asset whose position changed.
  ...
  // Every connection touching a moved asset needs new endpoints on the
  // GPU. Rewired connections definitely do too. Union then update.
